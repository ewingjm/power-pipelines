...
| deployServiceConnection **[optional]** | A separate Power Platform service connection to use for package deployment. If not provided, the pipeline uses `serviceConnection` for deployment as well.                                                                              |
