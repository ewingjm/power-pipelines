...
| templateEnvironmentUrl **[optional]**  | The URL of an existing Dataverse environment to copy from after the ephemeral environment is created. Use this when the fresh environment cannot be provisioned from scratch because of missing dependencies.                                 |
